    ...
    <section id="education" className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-[var(--text-muted)] text-sm sm:text-base max-w-xl mx-auto mt-4">
          Academic achievements, qualifications, and educational milestones.
        </p>
        ...
        >
          ...
          <span>{isExpanded ? 'Hide Education Information ▲' : 'View Education Information ✨'}</span>
        </button>
      </div>
        ...
        {isExpanded && (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {edList.map((item, idx) => {
                const isEdExpanded = activeEd?.id === item.id;
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span>{isEdExpanded ? 'Hide Academic Details ▲' : 'View Academic Information 🎓'}</span>
                      </button>
