    ...
    <section id="hobbies" className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-[var(--text-muted)] text-sm sm:text-base max-w-xl mx-auto mt-4">
          Activities and pursuits that spark joy, energy, and inspiration in my life.
        </p>
        ...
        >
          ...
          <span>{isExpanded ? 'Hide Hobbies Information ▲' : 'View Hobbies Information ✨'}</span>
        </button>
      </div>
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {hobbyList.map((hobby, idx) => {
                const isHobbyExpanded = activeHobby?.id === hobby.id;
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        <span>{isHobbyExpanded ? 'Hide Details ▲' : 'View Hobby Information ✨'}</span>
                      </button>
