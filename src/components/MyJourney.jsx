    ...
    <section id="journey" className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-[var(--text-muted)] text-sm sm:text-base max-w-xl mx-auto mt-4">
          Unfold the key milestones, life chapters, and inspiring moments of my growth.
        </p>
        ...
        >
          ...
          <span>{isExpanded ? 'Hide Journey Information ▲' : 'View Journey Information ✨'}</span>
        </button>
      </div>
            ...
            <div className="relative">
              ...
              <div className="space-y-8 sm:space-y-12">
                {milestones.map((item, idx) => {
                  ...
                  const isStoryExpanded = activeStory?.id === item.id;
                      ...
                      <div className="w-full sm:w-1/2 sm:px-8">
                        ...
                        >
                          ...
                          >
                            ...
                            <span>{isStoryExpanded ? 'Hide Story Details ▲' : 'View Story Information ✨'}</span>
                          </button>
